		...
		<div
			...
			<div className={cn({ "flex justify-center": id === 6 }, "h-full")}>
				...
				<div
					...
					<div className='font-sans text-white text-lg lg:text-3xl max-w-96 font-bold z-10'>
						{title}
					</div>
					...
					{id === 3 && (
						<div className='flex gap-1 lg:gap-5 w-fit absolute -right-3 lg:right-2 text-yellow-200'>
							<div className='flex flex-col gap-3 md:gap-3 lg:gap-8'>
								{leftLists.map((item, i) => (
									<span
										key={i}
										className='lg:py-4 lg:px-3 py-2 px-3 text-xs lg:text-base opacity-50 lg:opacity-100 rounded-lg text-center bg-blue-950'>
										{item}
									</span>
								))}
