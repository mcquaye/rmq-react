	...
	return (
		<div
			...
			<ul
				...
				{items.map((item, idx) => (
					<li
						className='w-[350px] max-w-full relative rounded-2xl border border-slate-300 hover:border-cyan-400 transition-all border-opacity-80 hover:border-opacity-100 flex-shrink-0 px-8 py-6 md:w-[450px]'
						style={{
							background: "linear-gradient(180deg, var(--black), #050a18)",
						}}
						key={item.name}>
						<blockquote>
							<div
